 ...
 * 
 */
public class WhoMeYueActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(R.layout.activity_meyuewho);
		new Title(this);//״̬ɫ
		init();// ʼؼ
		listViewRefresh();// ˢ
		...
		mPullToRefreshListView.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				...
				if (mPullToRefreshListView.getRefreshType() == PullToRefreshListView.MODE_PULL_DOWN_TO_REFRESH) {// ˢ
					lls = LodingDialog.DialogFactor(WhoMeYueActivity.this,
							"正在加载...", false);
	...
	private void init() {
		mPullToRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_meyuewho);
		intent = getIntent();
